    ...
    context("test overlappendede perioder") {
        context("Should overlap") {
            test("should overlapp if period is same") {
                ...
                val overlapperInfotrygd = sykmeldingService.hasOverlappingPeriodsFromInfotrygd(receivedSykmelding, infotrygdForesp)
            ...
            test("should overlap if new sykmelding starts on saturday, but not the old one") {
                coEvery { smregisterClient.getSykmeldinger(any(), any(), any()) } returns listOf(
                    generateSykmeldingDto(
                        perioder = listOf(
                            SykmeldingsperiodeDTO(LocalDate.of(2023, 1, 9), LocalDate.of(2023, 1, 13), null, PeriodetypeDTO.AKTIVITET_IKKE_MULIG),
                        ),
                    ),
                )
                val infotrygdForesp = InfotrygdForesp().apply {
                ...
                val receivedSykmelding = receivedSykmelding(
                    "1",
                    sykmelding = generateSykmelding(
                        perioder = listOf(generatePeriode(LocalDate.of(2023, 1, 7), LocalDate.of(2023, 1, 15))),
                    ),
                )
        ...
        context("Should not overlap") {
            ...
            test("fom is before fom in sykmelding in register") {
                ...
                coEvery { smregisterClient.getSykmeldinger(any(), any(), any()) } returns listOf(
                    generateSykmeldingDto(
                        perioder = listOf(
                            SykmeldingsperiodeDTO(LocalDate.of(2023, 1, 3), LocalDate.of(2023, 1, 7), null, PeriodetypeDTO.AKTIVITET_IKKE_MULIG),
                        ),
                    ),
                )
                val receivedSykmelding = receivedSykmelding(
                    "1",
                    sykmelding = generateSykmelding(
                        perioder = listOf(generatePeriode(LocalDate.of(2023, 1, 2), LocalDate.of(2023, 1, 7))),
                    ),
                )
                val infotrygdForesp = InfotrygdForesp().apply {
                    sMhistorikk = InfotrygdForesp.SMhistorikk().apply {
            ...
            test("tom is after tom in sykmelding in register") {
                ...
                coEvery { smregisterClient.getSykmeldinger(any(), any(), any()) } returns listOf(
                    generateSykmeldingDto(
                        perioder = listOf(
                            SykmeldingsperiodeDTO(LocalDate.of(2023, 1, 3), LocalDate.of(2023, 1, 11), null, PeriodetypeDTO.AKTIVITET_IKKE_MULIG),
                        ),
                    ),
                )
                val infotrygdForesp = InfotrygdForesp().apply {
                ...
                val receivedSykmelding = receivedSykmelding(
                    "1",
                    sykmelding = generateSykmelding(
                        perioder = listOf(generatePeriode(LocalDate.of(2023, 1, 3), LocalDate.of(2023, 1, 12))),
                    ),
                )
