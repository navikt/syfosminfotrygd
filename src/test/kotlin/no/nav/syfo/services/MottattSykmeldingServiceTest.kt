    ...
    FunSpec({
        ...
        context("handleMessage") {
            ...
            test(
                ...
                val healthInformation = createDefaultHealthInformation()
                val fellesformat = createFellesFormat(healthInformation)
                coEvery { smtssClient.getTssId(any(), any(), any(), any()) } returns "12345678912"
                val receivedSykmelding =
                    receivedSykmelding(
                        id = UUID.randomUUID().toString(),
                        sykmelding =
                ...
                receivedSykmelding(
                    ...
                    sykmelding =
                        generateSykmelding(
                            perioder =
                                listOf(
                                    generatePeriode(fom = startdato, tom = startdato.plusDays(10))
                                ),
                            medisinskVurdering =
                                MedisinskVurdering(
                                    hovedDiagnose = null,
        ...
        listOf(
            Godkjenning(
                helsepersonellkategori =
                    Kode(aktiv = true, oid = 0, verdi = HelsepersonellKategori.LEGE.verdi),
