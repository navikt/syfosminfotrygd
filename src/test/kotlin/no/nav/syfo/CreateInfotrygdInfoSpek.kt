...
object CreateInfotrygdInfoSpek : Spek({
    ...
    describe("Testing mapping of fellesformat and InfotrygdInfo") {
        ...
        it("Should map regelSettVersjon correctly") {
            ...
            val infotrygdFellesformat = createInfotrygdBlokk(fellesFormatString, itfh, healthInformation.aktivitet.periode.first(), "1231234", LocalDate.now(), "LE", "1341515", LoggingMeta(arrayOf(keyValue("mottakId", "12315"))), "0435")
        ...
        it("Should use arbeidsKategori to 01 when employers name is set") {
            ...
            val itfh = InfotrygdForespAndHealthInformation(infotrygdForesp, healthInformation)
            val infotrygdFellesformat = createInfotrygdBlokk(fellesFormatString, itfh, healthInformation.aktivitet.periode.first(), "1231234", LocalDate.now(), HelsepersonellKategori.LEGE.verdi, "1341515", LoggingMeta(arrayOf(keyValue("mottakId", "12315"))), "0435")
        ...
        it("Should NOT set arbeidsKategori") {
            ...
            val itfh = InfotrygdForespAndHealthInformation(infotrygdForesp, healthInformation)
            val infotrygdFellesformat = createInfotrygdBlokk(fellesFormatString, itfh, healthInformation.aktivitet.periode[1], "1231234", LocalDate.now(), HelsepersonellKategori.LEGE.verdi, "1341515", LoggingMeta(arrayOf(keyValue("mottakId", "12315"))), "0435", 2)
        ...
        it("Should set set fields for subsequent infotrygdblokk") {
            ...
            val itfh = InfotrygdForespAndHealthInformation(infotrygdForesp, healthInformation)
            val infotrygdFellesformat = createInfotrygdBlokk(fellesFormatString, itfh, healthInformation.aktivitet.periode[1], "1231234", LocalDate.now(), HelsepersonellKategori.LEGE.verdi, "1341515", LoggingMeta(arrayOf(keyValue("mottakId", "12315"))), "0135", 2)
