...
val MANUELLE_OPPGAVER_COUNTER: Counter =
    Counter.Builder()
        .namespace(NAMESPACE)
...
val ANNEN_FRAVERS_ARSKAK_CHANGE_TO_A99_COUNTER: Counter =
    Counter.Builder()
        .namespace(NAMESPACE)
...
val OVERLAPPER_PERIODER_COUNTER: Counter =
    Counter.Builder()
        .namespace(NAMESPACE)
...
val OVERLAPPENDE_PERIODER_IKKE_OPPRETT_OPPGAVE: Counter =
    Counter.Builder()
        .namespace(NAMESPACE)
...
val OVERLAPPENDE_PERIODE_SKIP_OPPGAVE: Counter =
    Counter.Builder()
        .namespace(NAMESPACE)
        .name("overlappende_perioder_skip_oppgave")
        .labelNames("type")
        .help("counts number of times we dont create oppgave for overlapping sykmeldinger")
        .register()
