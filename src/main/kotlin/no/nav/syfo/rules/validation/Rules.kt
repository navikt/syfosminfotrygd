...
val partiallConincidentSickLeavePeriodWithPreviousRegistertSickLave: ValidationRule = { sykmelding, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = infotrygdSykmelding != null &&
            ...
            (
                sykmeldingPerioder.sortedPeriodeFOMDate().first()
                    .isBefore(infotrygdSykmelding.sortedFOMDate().first()) ||
                    sykmeldingPerioder.sortedPeriodeTOMDate().last()
...
val sickLaveExtenionFromDiffrentNavOffice1: ValidationRule = { sykmelding, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = infotrygdSykmelding?.sortedSMInfos()?.lastOrNull()?.periode?.arbufoerFOM != null &&
            ...
            infotrygdSykmelding.sortedSMInfos().last().periode.arbufoerFOM.isBefore(
                sykmeldingPerioder.sortedPeriodeFOMDate().last()
            ) && infotrygdSykmelding.sortedSMInfos().last().periode?.utbetTOM != null &&
            infotrygdSykmelding.sortedSMInfos().last().periode.utbetTOM.isAfter(
                sykmeldingPerioder.sortedPeriodeFOMDate().last()
            ) && infotrygdSykmelding.sortedSMInfos()
...
val sickLaveExtenionFromDiffrentNavOffice2: ValidationRule = { sykmelding, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = infotrygdSykmelding?.sortedSMInfos()?.lastOrNull() != null &&
            !infotrygdSykmelding.sortedSMInfos()
                .last().periode?.friskKode.isNullOrBlank() &&
            !infotrygdSykmelding.sortedSMInfos()
                .last().periode?.hovedDiagnosekode.isNullOrBlank() &&
...
val sickLaveExtenionFromDiffrentNavOffice3: ValidationRule = { sykmelding, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = sykmeldingPerioder.sortedPeriodeFOMDate().lastOrNull() != null &&
            ...
            infotrygdSykmelding.sortedSMInfos().last().periode.utbetTOM.isBefore(
                sykmeldingPerioder.sortedPeriodeFOMDate().last()
            ) &&
            infotrygdSykmelding.sortedSMInfos().last().periode.utbetTOM.plusDays(3)
                .isAfter(
                    sykmeldingPerioder.sortedPeriodeFOMDate().last()
                ) &&
            infotrygdSykmelding.sortedSMInfos()
            .last().periode.utbetTOM.dayOfWeek >= java.time.DayOfWeek.FRIDAY &&
            sykmeldingPerioder.sortedPeriodeFOMDate().last().dayOfWeek in arrayOf(
...
val newCleanBillDateBeforePayout: ValidationRule = { sykmelding, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = sykmeldingPrognose?.arbeidsforEtterPeriode != null &&
            sykmeldingPrognose.arbeidsforEtterPeriode &&
            infotrygdSykmelding != null &&
            sykmeldingPerioder.sortedPeriodeTOMDate().lastOrNull() != null &&
            infotrygdSykmelding.sortedSMInfos()
            .lastOrNull()?.periode?.utbetTOM != null &&
            sykmeldingPerioder.sortedPeriodeTOMDate().last().isBefore(
...
val newCleanBillDateBeforeRegisteredCleanBillDate: ValidationRule = { sykmelding, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = infotrygdSykmelding?.sortedSMInfos()
            ...
            infotrygdSykmelding.sortedSMInfos()
            .lastOrNull()?.periode?.friskmeldtDato != null &&
            sykmeldingPerioder.sortedPeriodeTOMDate().last().plusDays(1).isBefore(
...
val extaionOverFa: ValidationRule = { sykmelding, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = infotrygdSykmelding != null &&
            ...
            infotrygdSykmelding.sortedSMInfos().last().historikk.sortedSMinfoHistorikk()
...
val personMovingKodeFl: ValidationRule = { _, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = infotrygdSykmelding?.find {
...
val periodForAAEnded: ValidationRule = { sykmelding, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = sykmeldingPerioder.any {
            !infotrygdSykmelding?.sortedSMInfos()
                ?.lastOrNull()?.periode?.stans.isNullOrBlank() &&
                ruleMetadata.infotrygdForesp.sMhistorikk.sykmelding.sortedSMInfos()
                .last().periode.arbufoerTOM != null &&
                ruleMetadata.infotrygdForesp.sMhistorikk.sykmelding.sortedSMInfos().last().periode.stans == "AA" &&
                it.fom.isBefore(
                    ruleMetadata.infotrygdForesp.sMhistorikk.sykmelding.sortedSMInfos().last().periode.arbufoerTOM
                )
        }
    )
}
...
val periodIsAf: ValidationRule = { sykmelding, ruleMetadata ->
    RuleResult(
        ...
        ruleResult = sykmelding.perioder.any {
            !ruleMetadata.infotrygdForesp.sMhistorikk?.sykmelding?.sortedSMInfos()
                ?.lastOrNull()?.periode?.stans.isNullOrBlank() &&
                ruleMetadata.infotrygdForesp.sMhistorikk.sykmelding.sortedSMInfos()
                .last().periode.arbufoerTOM != null &&
                ruleMetadata.infotrygdForesp.sMhistorikk.sykmelding.sortedSMInfos().last().periode.stans == "AF" &&
                it.fom.isBefore(
                    ruleMetadata.infotrygdForesp.sMhistorikk.sykmelding.sortedSMInfos().last().periode.arbufoerTOM
                )
        }
...
val errorFromItHouvedStatusKodeMelding: ValidationRule = { _, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = hovedStatusKodeMelding?.toIntOrNull() != null && hovedStatusKodeMelding.toInt() > 4
    )
}
...
val errorFromItSmgistorikkStatusKodemelding: ValidationRule = { _, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = smHistorikkKodeMelding?.toIntOrNull() != null && smHistorikkKodeMelding.toInt() > 4
    )
}
val errorFromItParalellytelserStatusKodemelding: ValidationRule = { _, ruleMetadata ->

    val parallelleYtelsesKodeMelding = ruleMetadata.infotrygdForesp.parallelleYtelser?.status?.kodeMelding
    ...
    RuleResult(
        ...
        ruleResult = parallelleYtelsesKodeMelding?.toIntOrNull() != null && parallelleYtelsesKodeMelding.toInt() > 4
    )
}
val errorFromItDiagnoseOkUtrekkStatusKodemelding: ValidationRule = { _, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = diagnoseKodeKodeMelding?.toIntOrNull() != null && diagnoseKodeKodeMelding.toInt() > 4
    )
}
val errorFromItPasientUtrekkStatusKodemelding: ValidationRule = { _, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = pasientStatusKodeMelding?.toIntOrNull() != null && pasientStatusKodeMelding.toInt() > 4
    )
}
val arbeiduforetomMangler: ValidationRule = { _, ruleMetadata ->
    ...
    RuleResult(
        ...
        ruleResult = sykmeldingInfotrygd != null &&
